...
#                ("icache_conflicts"          , re.compile(r'icache.replacements')),
                ("dcache_read_accesses"      , re.compile(r'l1_cntrl\d+.L1Dcache.demand_accesses|l1d_cntrl\d+.L1cache.demand_accesses')),
                ("dcache_read_misses"        , re.compile(r'l1_cntrl\d+.L1Dcache.demand_misses|l1d_cntrl\d+.L1cache.demand_misses')),
